...
orig <- "2021/data-raw/14b_extended_polymerization.txt" |>
...
poly <- "2021/data-raw/14b_extended_polymerization.txt" |>
  readr::read_lines(n_max = 1) |>
  stringr::str_split("") |>
  purrr::pluck(1) |>
...
rules <- "2021/data-raw/14b_extended_polymerization.txt" |>
