...
# to their score (for a total score of 2). The game immediately ends as a win
...
# rolls 1 first, then 2, then 3, and so on up to 100, after which it starts over
# at 1 again. Play using this die.
#
...
pos <- "2021/data-raw/21a_dirac_dice.txt" |>
  readr::read_lines() |>
